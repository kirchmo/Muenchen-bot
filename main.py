...
def check():
    ...
    if earliest < last_earliest:
        send_telegram(f"⚡ Früherer Termin verfügbar: {earliest} Link https://stadt.muenchen.de/buergerservice/terminvereinbarung.html#/appointment/eyJpZCI6MTUyNTkxLCJhdXRoS2V5IjoiY2JmMyJ9")
        last_earliest = earliest
    else:
